        ...
        while (self.target_settings['Use_Target'] == 'y' and Console.created < self.target_settings['Target_To']) or (
            ...
            try:
                if self.settings['Use_Proxy'] == 'y':
                    ...
                    session = httpx.Client(headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.6422.142 Safari/537.36'}, proxies=proxies, timeout=30)
                else:
                    session = httpx.Client(headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.6422.142 Safari/537.36'}, timeout=30)
                ...
                payload = {
                    ...
                    'client_info': {
                        ...
                        'app_version': '8.9.24.633',    #'8.8.56.538',
                        'capabilities': [1],
                ...
                headers = {
                    ...
                    'content-type': 'application/json',
                    'host': 'spclient.wg.spotify.com',
                    'spotify-app-version': '8.9.24.633',
                    'user-agent': 'Spotify/8.9.24.633 Android/28 (SM-S908E)',
                    'x-client-id': client_id
                }
